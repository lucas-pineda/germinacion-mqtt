...
#define PIN_RELAY_PUMP          19       // GPIO5  — bomba de agua (active-low)
...
#define SAMPLE_INTERVAL_MIN_MS  5000UL    // 300000 - 5 min  (nivel 9)
#define SAMPLE_INTERVAL_MAX_MS  15000UL   // 1800000 - 30 min (nivel 1)
